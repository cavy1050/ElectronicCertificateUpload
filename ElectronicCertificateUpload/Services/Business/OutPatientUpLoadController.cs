...
{
    public class OutPatientUpLoadController : IUpLoadController
    {
        string query;
        ...
        IEnumerable<dynamic> nativeDiagHub, nativeFeeDetailHub;
        ...
        public OutPatientUpLoadController(IContainerProvider containerProviderArg)
        {
        ...
        public async Task<int> CompareNativeToTargetRemoteRecord(DateTime beginTimeArg, DateTime endTimeArg)
        {
            ...
            //未成功上传的记录均重新上传,为避免标识键值重复,删除目标库重复标识键记录,以本地记录为准
            query = "SELECT BILL_MDTRT_INFO_ID,SETL_BILL_ID,HIS_GHXH,HIS_JSSJH," +
        ...
        public async Task<bool> SynchronizeNativeToTargetRemoteRecord()
        {
            ...
            if (DifferenceHub.Count != 0)
            {
                ...
                {
                    nativeMdtrtRec = nativeBillMasterRec = nativeBillStasRec = nativeBillRltsRec = nativeDiagHub = nativeFeeDetailHub = null;
        ...
        {
            query = "SELECT a.MDTRT_TYPE,c.BILL_CODE,c.BILL_NO,c.BILL_CHKCODE," +
        ...
        internal async Task PushMdtrtInfoIntoTargetRemoteRecord(RelationKind relationArg)
        {
            if (nativeMdtrtRec != null)
            {
                ...
                query = "INSERT INTO mid_bsw_bill_mdtrt_info" +
                        ...
                        "MED_TYPE, MATN_TYPE, BIRCTRL_TYPE, IPT_OTP_NO, MEDRCDNO," +
                        "SETL_ID, CHFPDR_CODE, CHFPDR_NAME, CRTE_TIME) " +
                        ...
                        "1','" + (relationArg.SELF_FUNDED_FLAG == "0" ? "1" : "2") + "','" + nativeMdtrtRec.MDTRT_TYPE + "', '" + relationArg.RHRED_FLAG + "','" + nativeMdtrtRec.REL_ELEC_SETL_CERT_CODE + "','" +
                        ...
                        nativeMdtrtRec.MED_TYPE + "', '" + nativeMdtrtRec.MATN_TYPE + "', '" + nativeMdtrtRec.BIRCTRL_TYPE + "', '" + nativeMdtrtRec.IPT_OTP_NO + "', '" + nativeMdtrtRec.MEDRCDNO + "', '" +
                        nativeMdtrtRec.SETL_ID + "', '" + nativeMdtrtRec.CHFPDR_CODE + "', '" + nativeMdtrtRec.CHFPDR_NAME + "', '" + DateTime.Now.ToString("G") + "') ";
        ...
        {
            query = "SELECT a.SETL_BILL_ID,a.BILL_CODE,a.BILL_NO,a.FILE_URL " +
            ...
            if (nativeFeeDetailHub.Count() != 0)
            {
                ...
                foreach (dynamic nativeFeeDetailRec in nativeFeeDetailHub)
                {
                    query = "INSERT INTO mid_bsw_fee_detl " +
                            ...
                            "VALUES('" + nativeFeeDetailRec.FEE_DETL_ID + "','" + relationArg.BILL_MDTRT_INFO_ID + "','" + nativeFeeDetailRec.BILL_CODE + "','" + nativeFeeDetailRec.BILL_NO + "','" +
